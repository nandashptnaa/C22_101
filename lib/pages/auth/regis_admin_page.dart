...
class RegisterSupAdminPage extends StatefulWidget {
  const RegisterSupAdminPage({Key? key}) : super(key: key);

  @override
  State<RegisterSupAdminPage> createState() => _RegisterSupAdminPageState();
}

class _RegisterSupAdminPageState extends State<RegisterSupAdminPage> {
  bool _isLoading = false;
  final formKey = GlobalKey<FormState>();
  String email = "";
  String password = "";
  String fullName = "";
  AuthServiceSupAdmin authServiceSupAdmin = AuthServiceSupAdmin();
  @override
  ...
  register() async {
    if (formKey.currentState!.validate()) {
      ...
      await authServiceSupAdmin
          .registerSupAdminEmailandPassword(fullName, email, password)
          .then((value) async {
        if (value == true) {
          // saving the shared preference state
          await HelperFunctionsSupAdmin.saveSupAdminLoggedStatus(true);
          await HelperFunctionsSupAdmin.saveSupAdminEmail(email);
          await HelperFunctionsSupAdmin.saveUserNameSupAdmin(fullName);
