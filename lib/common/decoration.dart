...
class AppDecoration {
  static BoxDecoration get outlineGray5031 => BoxDecoration(
  ...
  static BoxDecoration get txtOutlineLightblue700 => BoxDecoration(
  ...
  static BoxDecoration get outlineIndigoA10033 => BoxDecoration(
        color: ColorConstant.lightBlueA200,
        border: Border.all(
  ...
  static BoxDecoration get fillRed800cc => BoxDecoration(
        color: ColorConstant.red800Cc,
      );
  ...
  static BoxDecoration get outlineGray503 => BoxDecoration(
        color: ColorConstant.gray50,
        border: Border.all(
          color: ColorConstant.gray503,
          width: getHorizontalSize(
  ...
  static BoxDecoration get fillBlueA100 => BoxDecoration(
        color: ColorConstant.blueA100,
      );
  static BoxDecoration get fillIndigo900cc => BoxDecoration(
        color: ColorConstant.indigo900Cc,
      );
