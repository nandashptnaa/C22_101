    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Container(
            // frame4634 (4:244)
            margin: EdgeInsets.fromLTRB(0, 0, 0, 108),
            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  ...
                  margin: EdgeInsets.fromLTRB(0, 4.5, 217, 4.5),
            ...
            child: Stack(
              children: [
                        ...
                        child: Container(
                          decoration: const BoxDecoration(
                              image: DecorationImage(
                                  image: AssetImage("assets/sps4.jpeg"),
                                  fit: BoxFit.cover)),
                        ),
                      ),
                    ),
                ...
                Positioned(
                  ...
                  Container(
                          ...
                          child: ElevatedButton(
                              ...
                              onPressed:(){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => const HomeDaftar(),));
                              },
                              child: const Text(
                                "Selesai",
                ...
                Positioned(
                  ...
                  top: 330,
                  child: Container(
                    padding: EdgeInsets.fromLTRB(7, 19, 8, 18),
                    width: 248,
                    height: 107,
                    decoration: BoxDecoration(
          ...
          Container(
            // frame3jd4 (4:182)
            margin: EdgeInsets.fromLTRB(74, 0, 0, 0),
            width: 212.01,
            height: 37,
          ),
        ],
